...
# Esto es con el nuevo diseño mejorado por chatGPT

<div className="flex flex-col md:flex-row items-center gap-8 p-6 bg-white/60 rounded-2xl shadow-md">

  {/* Texto */}
  <div className="flex-1 text-justify leading-relaxed">
    <h2 className="text-2xl font-bold mb-3 text-gray-800">
      La historia de Gara y nuestro camino
    </h2>
    <p className="text-gray-700">
      Gara es una niña extraordinaria que convive con una traqueotomía,
      una gastrostomía y una válvula de derivación. Esta web nace para contar
      nuestra experiencia y ayudar a otras familias que puedan encontrarse en
      situaciones similares. Compartimos recursos, aprendizajes, trámites,
      y todo aquello que hubiese deseado saber desde el principio.
    </p>
  </div>
  ...
  <img
    src="/GaraPanda_Solo.png"
    alt="Logo GaraPanda"
    className="w-40 md:w-56 rounded-2xl shadow-lg object-contain"
  />
